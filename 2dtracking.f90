program main
    ...
    ! Todo - Calculation of mod_psi_infinite as per root(rho_infinite/m)
    mod_psi_infinite = 0.0000001

    ! Todo - need to check as per the condition
    ! initial guess
    x_guess[0] = 0.1
    x_guess[1] = 0.1
